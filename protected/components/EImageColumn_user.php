 ...
 *
 */
class EImageColumn_user extends CGridColumn
{
	public $name;
	...
	protected function renderDataCellContent($row,$data)
	{
                ...
                if($data->image=="")
                {
                    $image = CHtml::image($this->pathPrefix . 'default.png' . $this->pathSuffix,
				$this->alt,
				$this->htmlOptions);
                } 
                else
                {
                    $image = CHtml::image($this->pathPrefix . 'user_'.$data->user_id.'/'.$data->image . $this->pathSuffix,
				$this->alt,
				$this->htmlOptions);
                }
		...
		if($this->link)
			...
			echo "<a href='".Yii::app()->baseUrl."/index.php/user/userprofile/$data->id'>$image</a>";
